...
public class UserController {
	...
	// metodo retorna um objeto do tipo Response com usuário criado
	// Classe para padronizar comunicação entre angular - spring
	// quando chamar o end-point /api/user via post, cai nesse metodo aqui.
	// somente um administrador do sistema (admin) pode add um usuario
	@PostMapping()
	...
	// administrador do sistema pode alterar um usuario
	@PutMapping()
	@PreAuthorize("hasAnyRole('ADMIN')")
